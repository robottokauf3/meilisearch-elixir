defmodule Meilisearch do
  @moduledoc """
  A lightweight client for MeiliSearch search engine.
  ...
  * `Meilisearch.Dumps`: [Dumps API](https://docs.meilisearch.com/references/dump.html)
  * `Meilisearch.Health`: [Health API](https://docs.meilisearch.com/references/health.html)
  * `Meilisearch.Indexes`: [Indexes API](https://docs.meilisearch.com/references/indexes.html)
